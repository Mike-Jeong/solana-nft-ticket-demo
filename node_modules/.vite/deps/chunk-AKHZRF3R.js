...
var ICONS = {
  add: async () => (await import("./add-ETW3JEIJ.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-SSGK22B7.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-XQQARF6M.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-FPTS7SI6.js")).appStoreSvg,
  apple: async () => (await import("./apple-6DYKIL5U.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-XAD3Z43Y.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-THSPPUGH.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-E5AVTO4E.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LPOXSA2Q.js")).arrowTopSvg,
  bank: async () => (await import("./bank-HPL43SP3.js")).bankSvg,
  browser: async () => (await import("./browser-I7I4I7EZ.js")).browserSvg,
  card: async () => (await import("./card-JQICVCMN.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-GRDST2VJ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-5HJFV5B7.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-RCVE3QA4.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-MUUCBP6Y.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-ID2B22AD.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-KSXLPMW5.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-QYKW5HM5.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-D66UUZ46.js")).clockSvg,
  close: async () => (await import("./close-DA6G5C74.js")).closeSvg,
  compass: async () => (await import("./compass-6METUMWK.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ETUF2PPL.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-64VPDY76.js")).copySvg,
  cursor: async () => (await import("./cursor-BWLEWEWG.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-6FWUVRJ3.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-NNEDXFY2.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-YWLGHGYF.js")).disconnectSvg,
  discord: async () => (await import("./discord-CAUNPE2J.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-56TX5DRX.js")).etherscanSvg,
  extension: async () => (await import("./extension-NQPXKC6G.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-6VDLZU4K.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-XNY4JGB6.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-Y3K5GLIW.js")).farcasterSvg,
  filters: async () => (await import("./filters-HR7MA73D.js")).filtersSvg,
  github: async () => (await import("./github-DSMCJKIH.js")).githubSvg,
  google: async () => (await import("./google-FTMQR7EK.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-KNNQFICP.js")).helpCircleSvg,
  image: async () => (await import("./image-DO5TRYLQ.js")).imageSvg,
  id: async () => (await import("./id-HXCYNMC3.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-XBEHWJAE.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-3RJECLPA.js")).lightbulbSvg,
  mail: async () => (await import("./mail-6BQ5BJNA.js")).mailSvg,
  mobile: async () => (await import("./mobile-245OC2PW.js")).mobileSvg,
  more: async () => (await import("./more-RCC73234.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-OGGIQWWV.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-ZFJR26LC.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-EY2PGGSC.js")).offSvg,
  playStore: async () => (await import("./play-store-QHSMRTUY.js")).playStoreSvg,
  plus: async () => (await import("./plus-BIZEQIBZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-IVKXMV2Y.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-5Z3Y5NOZ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-YTVIYHIY.js")).refreshSvg,
  search: async () => (await import("./search-VHQBAEYA.js")).searchSvg,
  send: async () => (await import("./send-X55IUCRS.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-73D6EYHT.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-YADCSX3Q.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-AP6KYJVT.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-QWGRPKTN.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-Q4IDQFMX.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-COCGUUGJ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-AZTOQKNJ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-KRLS6HTC.js")).twitchSvg,
  twitter: async () => (await import("./x-LY5ZGV3H.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-R6ZM43GA.js")).twitterIconSvg,
  verify: async () => (await import("./verify-BFZ6AEVE.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-LZE2HBOE.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-5PNGHZKB.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-7QUQ2RLP.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-7QUQ2RLP.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-7QUQ2RLP.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SDVEBG4O.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-HO2DXMZV.js")).warningCircleSvg,
  x: async () => (await import("./x-LY5ZGV3H.js")).xSvg,
  info: async () => (await import("./info-7TTGQ6VU.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-6OVJESLZ.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-R7YI4TN7.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AKHZRF3R.js.map
